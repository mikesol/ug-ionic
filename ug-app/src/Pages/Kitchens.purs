...
import Components.VirtualScroller (virtualScroller)
import Control.Promise (toAffE)
import Data as Data
import Data.Array (drop, fold, length, replicate, take, zipWith, (..))
...
import Deku.DOM.Listeners (injectElement, runOn, runOn_)
import Deku.DOM.Listeners as DL
import Deku.DOM.Self as Self
import Deku.Do as Deku
import Deku.Hooks (guardWith, (<#~>))
...
swiperComponent { cart, setCart } =
  D.div [ DA.klass_ "w-full h-full" ]
    [ D.div
        ...
        [ D.div
            [ DA.klass_ "swiper-wrapper" ]
            (zipWith (mainSlide { cart, setCart }) (NAE.toArray Data.kitchens) (NAE.toArray Data.flatKitchens))
        ]
    ]
...
mainSlide :: _ -> Data.Kitchen -> Data.FlatKitchen -> Nut
mainSlide { cart, setCart } k fk = Deku.do
  let Data.Kitchen kitchen = k
  let Data.Kitchen flatKitchen = fk
  ...
  in
    D.div_
      ...
      , makeModal
          ...
          , setCart
          , item: ModalItem
              { title: fromMaybe "Today at UG" title
              , description
              , imageUrl
              , headerUrl
              , kitchenId
